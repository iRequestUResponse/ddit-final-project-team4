...
// cors
app.use(cors({
    origin: ['http://localhost:8081', 'http://localhost:8082', 'http://localhost:80', 'http://localhost', 'http://192.168.0.91:8081', 'http://192.168.0.121:8081', 'http://192.168.0.121:3000'],
