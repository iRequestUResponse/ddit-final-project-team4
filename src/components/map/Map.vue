...
<ul id="category">
  ...
  <p id="inputtag">
    <input type="checkbox" id="chkUseDistrict" @click="setOverlayMapTypeId" /> 지적편집도
    <input type="checkbox" id="chkTerrain" @click="setOverlayMapTypeId" /> 지형정보
...
// import { setMapType, zoomIn, zoomOut } from '@/assets/js/zoom.js';
